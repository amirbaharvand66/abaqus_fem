...
tapered = 'on' # tapered beam(on/off)
...
loads = [   [3,   1, 565486.6777]    ]

# Boundary conditions mat(node,ldof,disp)   
# For 2d beam element, u, v, theta(rotation)
bound = [   [1,  1,  0.0]  ]

# The present code only support contact below yielding stress
# constraint [node, dof, coefficient, distance]
cnst = [    [5, 1, 1, -0.1e-3]    ]